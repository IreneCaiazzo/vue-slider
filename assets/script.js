...
for (let i = 0; i < arrImages.length; i++) {
    ...
    `<div class="img_container ${i == 0 ? 'active' : ''}">
        <img src="${arrImages[i].image}" alt="" class="${i == 0 ? 'active' : ''}">
        <h2 class="title">${arrImages[i].title}</h2>
        <p class="text">${arrImages[i].text}</p>
    </div>`;
...
//     eleContainer.innerHTML = renderHighlighted(img);
// }

// function renderHighlighted(img){
//     return `
//     <div class="picture">
//         <img src="${img.image}" alt="" class="${i == 0 ? 'active' : ''}">
//         <div class="contents">
//             <h2>${img.title}</h2>
//             <p>${img.text}</p>
//         </div>
...
// 	containerHighlighted.innerHTML += `<img src="${img.image}" alt="" class="${i == 0 ? 'active' : ''}"> `;
// 	containerThumbs.innerHTML += `<img src="${img.image}" alt="" class="${i == 0 ? 'active' : ''}">`;
// }
